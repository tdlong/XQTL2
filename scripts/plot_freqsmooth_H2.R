...
#   THRESHOLD     numeric — draw a dashed line at this value (or NULL)
...
p <- ggplot(scans_df,
            aes(x = pos_mb, y = .data[[YVAR]], colour = label, group = label)) +
